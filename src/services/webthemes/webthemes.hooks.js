...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['name','type','description','keywords']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['name','description','keywords'] }), // This guy create json field stringify
