...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['title','short_desc','content','tags']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['title','short_desc','tags'] }), // This guy create json field stringify
