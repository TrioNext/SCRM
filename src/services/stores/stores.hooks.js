...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['address','phone', 'name']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['address','phone', 'name'] }), // This guy create json field stringify
