...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['type']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['type'] }), // This guy create json field stringify
    ...
    patch: [],
    remove: [
      delInSchema() /*  this gus add field : date_deleted - deleted_by -   */
    ]
  },
