...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['suplier_id','inventorie_id','store_id','action_type']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['action_type'] }), // This guy create json field stringify
