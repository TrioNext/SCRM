...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['customer_id','type']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['code'] }), // This guy create json field stringify
