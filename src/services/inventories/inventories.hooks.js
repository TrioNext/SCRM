...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['name', 'code', 'address','phone']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['name', 'code', 'address','phone'] }), // This guy create json field stringify
