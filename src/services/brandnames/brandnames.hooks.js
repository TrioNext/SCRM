...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['name','url','photos']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['name','url','photos'] }), // This guy create json field stringify
