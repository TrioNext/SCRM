...
module.exports = {
  before: {
    ...
    create: [
      ...
      postInSchema({Helper,schema:['code','name','type','channels']}), /* this guy return err: on missing Default field */
      generateJsonField({ Helper ,schema :['code','name','type'] }), // This guy create json field stringify
